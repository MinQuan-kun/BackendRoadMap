 ...
 **GameDev & IT Developer Roadmap** — Hệ thống hỗ trợ xây dựng lộ trình học tập, hướng nghiệp và kết nối tuyển dụng dành cho lập trình viên Game & Công nghệ thông tin. Dự án được thiết kế chuyên nghiệp, linh hoạt với cấu trúc Graph-based Roadmap giúp học viên đi từ con số 0 đến khi có việc làm thành công.
...
*   **API Service (Backend):** `https://backendservice-sa6x.onrender.com`
*   **Trạng thái Deployment:** Đã cấu hình tệp `render.yaml` và `Dockerfile` tối ưu hóa cho môi trường Production.
